...
case 'mylist': {
  ...
  return (
    <div className="app-layout">
      ...
      {/* PWA UPDATE BANNER */}
      {showUpdateBanner && (
        <div className="update-banner" style={{ flexDirection: 'column', gap: '0.6rem', padding: '0.9rem 1.25rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', width: '100%' }}>
            <span className="update-banner-text">
              KuramaTracker actualizado
            </span>
            <div style={{ display: 'flex', gap: '0.5rem', flexShrink: 0 }}>
              <button className="update-banner-btn" onClick={handleUpdateApp}>
                Actualizar
              </button>
              <button
          ...
          <p style={{ fontSize: '0.76rem', color: 'rgba(255,255,255,0.6)', margin: 0, lineHeight: '1.4' }}>
            Si el icono sigue siendo el antiguo: desinstala la app y vuelvela a instalar desde el navegador.
          </p>
        </div>
      )}
